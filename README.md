...
```
(curl -LfsS https://raw.githubusercontent.com/asd307769162/MTProxy/refs/heads/2/MTP.sh -o /usr/local/bin/mtp || wget -q https://https://raw.githubusercontent.com/asd307769162/MTProxy/refs/heads/2/MTP.sh -O /usr/local/bin/mtp) && chmod +x /usr/local/bin/mtp && mtp
```
